...
/*xiaobin.wang modify for system ro*/
/*
#define QMI_QMUX_IF_CONN_SOCKET_PATH          "/var/qmux_connect_socket"
#define QMI_QMUX_IF_CLIENT_SOCKET_PATH        "/var/qmux_client_socket"
*/

#define QMI_QMUX_IF_CONN_SOCKET_PATH          "/data/qmux_connect_socket"
#define QMI_QMUX_IF_CLIENT_SOCKET_PATH        "/data/qmux_client_socket"
