...
typedef struct {
  ...
  */
  //zhusilin add start
  uint8_t report_serial_port_mode_valid;
  uint8_t report_serial_port_mode;
  //zhusilin add end
...
}dms_send_sdcard_data_type_v01;  /* Type */
...
typedef struct {
  ...
  /*  Result Code */
  qmi_response_type_v01 resp;
}dms_send_sdcard_data_resp_msg_v01;  /* Message */
//zhoupan add end
...
typedef struct {
  ...
  /* Mandatory */
  uint32_t nv_num;
}get_nv_item_req_msg_v01;  /* Message */
...
typedef struct {
  ...
  /* Mandatory */
  uint8_t nv_data[QMI_DMS_NV_DATA_LEN_V01];
...
typedef struct {
  ...
  uint32_t data_len;  /**< Must be set to # of elements in data */
  uint8_t data[QMI_DMS_NV_DATA_LEN_V01];
  /**<   User data from/to persistent storage (maximum 512). */
}dms_nv_data_type_v01;  /* Type */
...
typedef struct {
  ...
  /* Mandatory */
  /*  User Data */
  dms_nv_data_type_v01 user_data;
